output "hostname" {
  ...
  value       = try(one(module.aws[*].hostname), one(module.yc[*].hostname), "")
}
...
output "public_ip" {
  ...
  value       = try(one(module.aws[*].public_ip), one(module.yc[*].public_ip), "")
}
...
output "private_ip" {
  ...
  value       = try(one(module.aws[*].private_ip), one(module.yc[*].private_ip), "")
}
...
output "id" {
  ...
  value       = try(one(module.aws[*].id), one(module.yc[*].id), "")
}
