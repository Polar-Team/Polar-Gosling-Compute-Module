...
```hcl
module "runner" {
  source = "git::https://github.com/your-org/Polar-Gosling-Compute-Module.git?ref=v1.0.0"
...
```hcl
module "runner" {
  source = "./polar-gosling-compute-module"
  # ...
}
```
...
| <a name="input_owner"></a> [owner](#input\_owner) | (Optional) Lables with owner markers | `string` | `"polar-team"` | no |
