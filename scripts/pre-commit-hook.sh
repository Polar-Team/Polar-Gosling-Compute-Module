...
- repo: $REPO
  ...
  hooks:
    ...
    - id: tofu_docs
      exclude: '(\.github/|tests/)'
      args:
        - --args=--hide=providers                       # The Providers section pulls versions from
                                                        # .terraform.lock.hcl, which is gitignored in
                                                        # this repo and regenerated by 'tofu init
                                                        # -upgrade' on every CI run. Hiding it keeps
                                                        # the docs output deterministic. The same
                                                        # version info is already in Requirements.
