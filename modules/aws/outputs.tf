output "hostname" {
  ...
  value = (
    var.aws_vm_create ? aws_instance.this[0].tags["Name"] :
    var.aws_ecs_create ? aws_ecs_task_definition.this[0].tags["Name"] :
    ""
  )
}
...
output "public_ip" {
  ...
  value = (
    var.aws_vm_create ? aws_instance.this[0].public_ip :
...
output "private_ip" {
  ...
  value = (
    var.aws_vm_create ? aws_instance.this[0].private_ip :
    var.aws_ecs_create ? "serverless" :
    ""
  )
}
...
output "id" {
  ...
  value = (
    var.aws_vm_create ? aws_instance.this[0].id :
    var.aws_ecs_create ? aws_ecs_task_definition.this[0].id :
    ""
  )
}
