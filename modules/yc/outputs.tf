output "hostname" {
  ...
  value = try(
    yandex_compute_instance.this[0].hostname,
    yandex_serverless_container.this[0].name,
    ""
  )
}
...
output "public_ip" {
  ...
  value = try(
    yandex_compute_instance.this[0].network_interface[0].nat_ip_address,
...
output "private_ip" {
  ...
  value = try(
    yandex_compute_instance.this[0].network_interface[0].ip_address,
    var.yc_serverless_create ? "serverless" : "",
    ""
  )
}
...
output "id" {
  ...
  value = try(
    yandex_compute_instance.this[0].id,
    yandex_serverless_container.this[0].id,
    ""
  )
}
