output "hostname" {
  ...
  value       = var.yc_vm_create ? yandex_compute_instance.this[0].hostname : var.yc_serverless_create ? yandex_serverless_container.this[0].name : ""
}
...
output "public_ip" {
  ...
  value       = var.yc_vm_create ? yandex_compute_instance.this[0].network_interface[0].nat_ip_address : var.yc_serverless_create ? "serverless" : ""
}
...
output "private_ip" {
  ...
  value       = var.yc_vm_create ? yandex_compute_instance.this[0].network_interface[0].ip_address : var.yc_serverless_create ? "serverless" : ""
}

output "id" {
  description = "ID of the created YC resource (compute instance ID or serverless container ID)."
  value       = var.yc_vm_create ? yandex_compute_instance.this[0].id : var.yc_serverless_create ? yandex_serverless_container.this[0].id : ""
}
